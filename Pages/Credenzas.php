...
$Consulta = "Select * from Articulos where Categoria = 'Credenzas'";
...
<head>
    ...
    <title>Categoría: Credenzas</title>
...
<body>
            ...
            <div id="ContenedorP">
                ...
                <ul>
                            <?php if (isset($_SESSION['cart'])) : ?>
                                ...
                                <form aclass="BodyModalCart"ction="Credenzas.php" method="post">
    ...
    <div id="Subtitulo">
    <span>
        Bienvenido a la categoría de credenzas!!
    </span>
    <!-- Terminar las categorías y subirlas al servidor -->
    <hr>
    </div>
    <table id="ContentAll">
        <tr>
                ...
                <td class="Art">
                    <section class="Producto">
                        <article class="Contenido">
                            ...
                            <form action="Credenzas.php" method="post">
