...
$Consulta = "Select * from Articulos where Categoria = 'Otros'";
...
<body>
            ...
            <div id="ContenedorP">
                ...
                <ul>
                            <?php if (isset($_SESSION['cart'])) : ?>
                                ...
                                <form aclass="BodyModalCart"ction="Otros.php" method="post">
    ...
    <div id="Subtitulo">
    <span>
        Bienvenido a la subcategoría otros!!
    </span>
    <hr>
    </div>
