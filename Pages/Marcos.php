...
$Consulta = "Select * from Articulos where Categoria = 'Marcos'";
...
<body>
            ...
            <div id="ContenedorP">
                ...
                <ul>
                            <?php if (isset($_SESSION['cart'])) : ?>
                                ...
                                <form aclass="BodyModalCart"ction="Marcos.php" method="post">
    ...
    <div id="Subtitulo">
    <span>
        Bienvenido a la categoría de marcos!!
    </span>
    <hr>
    </div>
    <table id="ContentAll">
                ...
                <td class="Art">
                    <section class="Producto">
                        <article class="Contenido">
                            ...
                            <form action="Marcos.php" method="post">
    ...
    <div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <hr style="font-weight: 900; color: black; width: 90%;">
                <label class="Medidas" style="font-weight: 600;">Medidas: Alto - <?php echo $product['alto']; ?> | Largo - <?php echo $product['largo']; ?></label>
            </div>
