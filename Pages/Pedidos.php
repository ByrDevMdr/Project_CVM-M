...
$Consulta = "Select `Id_Pedido`,`Pedido`,`Estado`,`Avance`,`Fecha`,`Total`, `Resto` from Pedidos where Id_Cliente = {$_SESSION['IdUser']}";
...
<link href="https://fonts.googleapis.com/css2?family=Roboto&display=swap" rel="stylesheet">
    ...
    <link rel="stylesheet" href="StylePedd.css">
    <!-- Favicon -->
...
<table class="head" id="Head">
        <tr>
            ...
            <td class="head" id="ContentTitulo">
                <span id="Titulo">Información de pedidos</span>
            </td>
...
<section id="ContentTable">
    <article id="ContentNoOrder">
        <span id="NoOrder">Usted no tiene pedidos pendientes..</span>
    </article>
    <table id="UserList">
        <tr>
