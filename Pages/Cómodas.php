...
$Consulta = "Select * from Articulos where Categoria = 'Cómodas'";
...
<body>
            ...
            <div id="ContenedorP">
                ...
                <ul>
                            <?php if (isset($_SESSION['cart'])) : ?>
                                ...
                                <form aclass="BodyModalCart"ction="Cómodas.php" method="post">
    ...
    <div id="Subtitulo">
    <span>
        Bienvenido a la categoría de cómodas!!
    </span>
    <hr>
    </div>
    <table id="ContentAll">
                ...
                <td class="Art">
                    <section class="Producto">
                        <article class="Contenido">
                            ...
                            <form action="Cómodas.php" method="post">
