...
$Consulta = "SELECT `Pedidos`.`Id_Pedido`, `Clientes`.`Id_Cliente`, `Pedidos`.`Pedido`, `Pedidos`.`Estado`, `Pedidos`.`Avance`, `Pedidos`.`Fecha`, `Pedidos`.`Total`, `Pedidos`.`Resto`, `Nombre` as `Nombre` 
             FROM `Pedidos` 
...
<table class="head" id="Head">
        <tr>
            ...
            <td class="head" id="ContentTitulo">
                <span id="Titulo">Sesión de trabajador: Información de cuentas</span>
            </td>
...
<article id="ContentNoOrder">
        <span id="NoAbono">Aún no tiene cuentas pendientes..</span>
    </article>
    <table id="UserList">
        <tr>
